...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2025 at 04:52 AM
...
--
-- Table structure for table `deletion request`
--

CREATE TABLE `deletion request` (
  `request_id` int(11) NOT NULL,
  `email` varchar(250) NOT NULL,
  `account_type` enum('Family','Resident','','') NOT NULL COMMENT 'Family or Resident ',
...
--
-- Indexes for table `deletion request`
--
ALTER TABLE `deletion request`
...
--
-- AUTO_INCREMENT for table `deletion request`
--
ALTER TABLE `deletion request`
